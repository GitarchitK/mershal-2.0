...
export const customTopics = [
  ...
  // App Development
  { topic: 'How to build a mobile app with Flutter - Complete guide', category: 'apps' },
  { topic: 'iOS app development with Swift - Getting started', category: 'apps' },
  { topic: 'Android app development with Kotlin tutorial', category: 'apps' },
  { topic: 'Build a cross-platform app with React Native', category: 'apps' },
  { topic: 'Progressive Web Apps (PWA) - The future of web apps', category: 'apps' },
  { topic: 'Best productivity apps for developers in 2026', category: 'apps' },
  { topic: 'Top VS Code extensions every developer should use', category: 'apps' },
  { topic: 'Best code editors in 2026 - VS Code vs others', category: 'apps' },
  
  // Computer Hardware & Reviews
  { topic: 'Best laptops for programming in 2026 - Detailed review', category: 'reviews' },
  { topic: 'Build your own PC for coding - Component guide', category: 'reviews' },
  { topic: 'SSD vs HDD - What programmers need to know', category: 'reviews' },
  { topic: 'Best monitors for developers in 2026', category: 'reviews' },
  { topic: 'Mechanical keyboards for coding - Are they worth it', category: 'reviews' },
  { topic: 'MacBook Pro vs Windows laptop for developers 2026', category: 'reviews' },
  { topic: 'Best wireless mice for programming - Review', category: 'reviews' },
  ...
  { topic: 'Software developer salary guide 2026', category: 'reviews' },
